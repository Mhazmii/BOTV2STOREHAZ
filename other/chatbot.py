...
while(True):
 ...
 if re.findall(r"hallo", user):
    ...
    print("Hazstore : ", random.choice(bot2))
 elif re.findall(r"siapa namamu?|namamu siapa?", user): 
    print("Hazstore : ", random.choice(nama))
 elif re.findall(r"kenalan yok?|kenalan yuk?", user):
    print("Hazstore : ", random.choice(kenalan))
 elif re.findall(r"boleh kenalan?|boleh kenalan ga nih?", user):
    print("Hazstore : ", random.choice(kenalan2))
 elif re.findall(r"darimana asalmu?|asalmu darimana?|dimana asalmu?|asalmu dimana ?|kalo boleh tau asalmu darimana?", user):
    print("Hazstore : ", random.choice(asal))
 elif re.findall(r"siapa penciptamu?|siapa yang membuat kamu?|siapa pembuatmu?|pembuatmu siapa?|penciptamu siapa?", user):
    print("Hazstore : ", random.choice(cipta))
 elif re.findall(r"dimana tempat tinggalmu?|dimana tinggalmu|tinggal dimana kamu?|kamu tinggal dimana?|Hazstore tinggal dimana?|dimana tempat tinggal mu?|dimana tempatmu?", user):
    print("Hazstore : ", random.choice(tempat_tinggal))
 elif re.findall(r"apakah kau mau menjadi pacarku?|apakah kamu mau menjadi pacarku?|apa kamu mau menjadi pacarku?|kamu mau ga jadi pacarku?|kamu mau jadi pacarku?|kamu mau jadi pacarku?|Hazstore mau jadi pacarku?|Hazstore mau ga jadi pacarku?|mau ga jadi pacar aku?", user):
 	  print("Hazstore : ", random.choice(jadi)) 
    ...
    print("Hazstore : ", random.choice(kue))
    ...
    print("Hazstore : ", random.choice(ganteng))
    ...
    print("Hazstore : ", random.choice(rindu))
    ...
    print("Hazstore : ", random.choice(kangen))
    ...
    print("Hazstore : ", random.choice(rindu2))
    ...
    print("Hazstore : ", random.choice(crnmbk))
 else:
